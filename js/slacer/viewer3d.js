...
;(function() {
    ...
    function Viewer3D(settings) {
        // self alias
        var self = this;                    // in here, "this" is point to window object (under not strict model). On the other hand, "this" is "undefined" under strict model.     PS: strict model-> "use strict"
